...
echo ""
echo "🌍 Access URLs:"
echo "  ERPNext Backend: http://localhost:8100"
echo "  Frontend App:    http://localhost:3000 (manual start required)"
echo ""
...
echo "  Backend server logs:  docker-compose logs -f frappe"
echo "  Restart backend:      docker-compose restart frappe"
echo "  Start frontend:       cd apps/erpnext-frontend && npm install && npm run dev"
echo ""
